...
---
title: "DE Analysis (Lesional Skin, fig 6) II: Make Volcano plots"
...
Set variables: RNG seed to make code reproducible and to remove WGCNA "grey" module genes (which are not assigned to any module)
...
Declare data structures to run for different tissues, including setting output folders
...
Comment first line and uncomment line below To run for Nonlesional skin and Blood as well, 


```{r main_loop, out.width = "100%", fig.asp = 0.42}
